...
public class client extends JagApplet {
    ...
    public static void main(String args[]) {
        try {
            System.out.println("RS2 user com.jagex.runescape.client - release #" + 377);
            RsaParser.parse();
            world = 10;
            portOffset = 0;
            switchToHighMem();
            ...
            if (anInt1169 != -1 && anInt1169 == anInt1231) {
                ...
                if (key == 13 || key == 10) {
                    ...
                    if (anInt1221 == 3 && aString1026.length() > 0) {
                        ...
                        //aString1026 = com.jagex.runescape.ChatFilter.applyCensor((byte) 0, aString1026);
                ...
                if ((key == 13 || key == 10) && chatInput.length() > 0) {
                    ...
                    if (chatInput.startsWith("::")) {
                        ...
                        //  chatInput = com.jagex.runescape.ChatFilter.applyCensor((byte) 0, chatInput);
    ...
    public boolean parseIncomingPacket() {
        ...
        try {
            ...
            if (opcode == 76) { // open welcome com.jagex.runescape.screen
            ...
            if (opcode == 135) { // private message (?)
                ...
                if (!flag4 && anInt1246 == 0)
                    try {
                        ...
                        if (rights != 3)
                            //s9 = com.jagex.runescape.ChatFilter.applyCensor((byte) 0, s9);
    ...
    public void method57(int i, boolean flag) {
        ...
        for (int j = 0; j < localNpcCount; j++) {
            ...
            if (!class50_sub1_sub4_sub3_sub1.def.isClickable)
                k += 0x80000000;
    ...
    public void method6() {
        ...
        try {
            ...
            titleArchive = method61(14076, archiveHashes[1], "title", 25, 1, "title com.jagex.runescape.screen");
    ...
    public void method82(NpcDefinition class37, int i, int j, int k, byte byte0) {
        ...
        if (class37.transformations != null)
            class37 = class37.getTransformedDefinition();
        if (class37 == null)
            return;
        if (!class37.isClickable)
            return;
    ...
    public void method87(int i) {
        ...
        for (int j6 = 0; j6 < localNpcCount; j6++) {
            ...
            if (class50_sub1_sub4_sub3_sub1 != null && class50_sub1_sub4_sub3_sub1.isVisible()) {
                ...
                if (class37.transformations != null)
                    class37 = class37.getTransformedDefinition();
                if (class37 != null && class37.hasMinimapDot && class37.isClickable) {
